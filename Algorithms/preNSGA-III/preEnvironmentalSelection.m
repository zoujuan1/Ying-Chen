function Population = preEnvironmentalSelection(Population,N,Z,Zmin,PopObjs)
...
%--------------------------------------------------------------------------
    ...
    [FrontNo,MaxFNo] = NDSort(PopObjs,Population.cons,N);
    Next = FrontNo < MaxFNo;
    
    %% Select the solutions in the last front
    Last   = find(FrontNo==MaxFNo);
    
    Choose = LastSelection(PopObjs(Next,1:end),PopObjs(Last,1:end),N-sum(Next),Z,Zmin);
